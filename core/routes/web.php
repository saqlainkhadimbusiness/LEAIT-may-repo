...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('users/subscribed', 'ManageUsersController@subscribedUsers')->name('users.subscribed');
        ...
        Route::get('plan/custom_ref_bonus/edit', 'MlmController@Custom_ref_bonus_edit');
        Route::post('plan/update', 'MlmController@planUpdate')->name('plan.update');

        Route::get('ads', 'MlmController@ads')->name('ads');
        Route::post('storeads', 'MlmController@storeads')->name('storeads');
        Route::post('updateads', 'MlmController@updateads')->name('updateads');
...
Route::name('user.')->group(function () {
    ...
    Route::get('postregister', 'Auth\RegisterController@postRegister')->name('regComplete');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('/ads', 'PlanController@ads')->name('ads');
            Route::get('/viewads/{id}', 'PlanController@viewads')->name('viewads');
            Route::post('/addrevenue', 'PlanController@addrevenue')->name('addrevenue');
            Route::get('/ads_status', 'PlanController@ads_status')->name('ads_status');
...
Route::get('/payouts', 'SiteController@payouts')->name('payouts');
Route::get('/referral', 'SiteController@referral')->name('referral');
