...
class WithdrawalController extends Controller
{
    ...
    public function reject(Request $request)
    {
        ...
        $withdrawed_bonuses=withdraw_bonus::where('withdrawal_id',$withdraw->id)->first();
        if(isset($withdrawed_bonuses->withdrawed_bonus)  && $withdrawed_bonuses->withdrawed_bonus){
            $withdrawed_bonus=$withdrawed_bonuses->withdrawed_bonus;
        } else {
        $withdrawed_bonus=0;
        }
        ...
        $user->balance += getAmount($withdraw->amount) - $withdrawed_bonus;
        $user->save();

        withdraw_bonus::where('withdrawal_id',$withdraw->id)->delete();
