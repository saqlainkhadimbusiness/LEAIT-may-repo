...
class SiteController extends Controller
{
     ...
     public function about()
    {
        ...
        return view($this->activeTemplate . 'who', $data);
    }

    public function payouts()
    {
        $data['page_title'] = "Recent Payouts";
        $data['contact'] = Frontend::where('data_keys', 'contact_us.content')->first();
        return view($this->activeTemplate . 'payouts', $data);
    }

    public function referral()
    {
        $data['page_title'] = "Referral Contests";
        $data['contact'] = Frontend::where('data_keys', 'contact_us.content')->first();
        return view($this->activeTemplate . 'referral', $data);
    }
