...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function postRegister(Request $request)
    {
        ...
        return view($this->activeTemplate . 'user.auth.post-registration', compact('page_title'));
    }
      ...
      protected function create(array $data)
    {
        ...
        $user->cnic = $data['cnic'];
        if ($data['payment_processor'] == '') {
            $user->payment_processor = '';
        } else {
            $user->payment_processor = $data['payment_processor'];
        }

        if ($data['merchant_account'] == '') {
            $user->merchant_account = '';
        } else {
            $user->merchant_account = $data['merchant_account'];
        }
        $user->package_plan = $data['package_plan'];
        $user->working_place = $data['working_place'];
        $user->interested_in = $data['interested_in'];
        $user->questionone = $data['questionone'];
        $user->answerone = $data['answerone'];
        $user->questiontwo = $data['questiontwo'];
        $user->answertwo = $data['answertwo'];
        $user->save();
    ...
    public function registered(Request $request, $user)
    {
        ...
        return $this->postRegister($request);//redirect()->route('user.home');
    }
