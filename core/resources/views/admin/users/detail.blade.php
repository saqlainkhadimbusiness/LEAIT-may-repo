            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Balance')
                            <span class="font-weight-bold"> {{ getAmount($user->balance) +$adRevenue +getAmount($user->pairing_bonus) +getAmount($user->matching_bonus) +getAmount($user->total_ref_com)+getAmount($user->total_binary_com) - $withdraw_bonuses }} {{ $general->cur_text }} </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total BV')
